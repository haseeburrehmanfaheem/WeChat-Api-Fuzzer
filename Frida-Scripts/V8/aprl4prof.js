...
function resultToString(result, isolateAddress){
    ...
    v8_String_Utf8Value_Constructor(utf8ValueAddress, isolateAddress, result);
...
async function main(){
    ...
    if(executed == true) return
            ...
            const profiler = v8_profiler_new(isolateAddress2, 0, 0);
            // const profiler = ptr(0x7292e4a100)
