Java.perform(function () {
    ...
    try {
        BluetoothManagerService = Java.use("com.android.server.vibrator.VibratorManagerService");
    } catch (err) {
        console.log("Trying alternative class loaders...");
        Java.enumerateClassLoaders({
            onMatch: function(loader) {
                try {
                    if (loader.findClass("com.android.server.vibrator.VibratorManagerService")) {
                        classLoader = loader;
